...
const stripePromise = loadStripe(process.env.REACT_APP_APP_STRIPE_KEY);
const paymentForm = {
    firstName: {
        name: "firstName",
        validate: {
...
const Checkout = ({
    ...
    // console.log(process.env.REACT_APP_APP_PAYMENT_TYPE);
    ...
    const onConfirmPassword = (e) => {
        if (watch("password") !== e.target.value) {
            return setError(paymentForm.repeatPassword.name, {
                type: "notMatch",
    ...
    return (
        <Fragment>
            <MetaTags>
                <title>
                    {merchant.name} | {strings["Checkout"]}
                </title>
                {/* <meta
          name="description"
        ...
        /> */}
            ...
            <BreadcrumbsItem to={process.env.PUBLIC_URL + pathname}>{strings["Checkout"]}</BreadcrumbsItem>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-6 col-md-6">
                                                    <div className="billing-info mb-20">
                                                        ...
                                                        <input
                                                            type="text"
                                                            name={paymentForm.postalCode.name}
                                                            ref={register(paymentForm.postalCode.validate)}
                                                            onChange={() => {
                                                                clearTimeout(timer);
                                                                setTimer(
                                                                    setTimeout(function () {
                                                ...
                                                <div>
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="billing-info mb-20">
                                                            ...
                                                            <input
                                                                type="password"
                                                                name={paymentForm.password.name}
                                                                ref={register(paymentForm.password.validate)}
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="billing-info mb-20">
                                                            ...
                                                            <input
                                                                type="password"
                                                                name={paymentForm.repeatPassword.name}
                                                                ref={register(paymentForm.repeatPassword.validate)}
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-6 col-md-6">
                                                            <div className="billing-info mb-20">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    name={paymentForm.shipFirstName.name}
                                                        ...
                                                        <div className="col-lg-6 col-md-6">
                                                            <div className="billing-info mb-20">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    name={paymentForm.shipLastName.name}
                                                        ...
                                                        <div className="col-lg-12">
                                                            <div className="billing-info mb-20">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    name={paymentForm.shipCompany.name}
                                                                    ref={register(paymentForm.shipCompany.validate)}
                                                                />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="col-lg-12">
                                                            <div className="billing-info mb-20">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    name={paymentForm.shipCity.name}
                                                        ...
                                                        <div className="col-lg-6 col-md-6">
                                                            <div className="billing-info mb-20">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    name={paymentForm.shipPostalCode.name}
                                                                    ref={register(paymentForm.shipPostalCode.validate)}
                                                                    onChange={() => {
                                                                        clearTimeout(timer);
                                                                        setTimer(
                                                                            setTimeout(function () {
                            ...
                            <div className="col-lg-6 col-md-6">
                              ...
                              <ul>
                                ...
                                <li>Free shipping</li>
                                            ...
                                            {process.env.REACT_APP_APP_PAYMENT_TYPE === "NUVEI" && (
                                                <iframe
                                                    title="Payment Page"
                                                    height={"1150"}
                                                    width="570"
                                                    srcDoc='<form action="https://testpayments.nuvei.com/merchant/paymentpage" method="post">
