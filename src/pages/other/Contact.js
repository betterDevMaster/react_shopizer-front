...
const Contact = ({ strings, location, merchant, setLoader }) => {
    ...
    return (
        ...
        /> */}
            ...
            <BreadcrumbsItem to={process.env.PUBLIC_URL + pathname}>{strings["Contact"]}</BreadcrumbsItem>
                                ...
                                <div className="contact-info-wrap">
                                    ...
                                    <div className="single-contact-info">
                                        ...
                                        <div className="contact-info-dec">
                                            ...
                                            <p>
                                                {merchant.address.city}, {merchant.address.stateProvince}, {merchant.address.country}
                                            </p>
                                    ...
                                    <form className="contact-form-style" onSubmit={handleSubmit(onSubmitContactForm)}>
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <input
                                                    type="text"
                                                    name={contactForm.username.name}
                                                    ref={register(contactForm.username.validate)}
                                            ...
                                            <div className="col-lg-6">
                                                <input
                                                    ...
                                                    ref={register(contactForm.email.validate)}
