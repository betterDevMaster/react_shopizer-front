...
const Cart = ({
    ...
    const { register: codeRef, handleSubmit: codeSubmit, errors: codeErr } = useForm({ mode: "onChange" });
    ...
    return (
        <Fragment>
            <MetaTags>
                <title>
                    {merchant.name} | {strings["Place your order"]}
                </title>
                {/* <meta
          name="description"
        ...
        /> */}
            ...
            <BreadcrumbsItem to={process.env.PUBLIC_URL + pathname}>{strings["Cart"]}</BreadcrumbsItem>
                                                        ...
                                                        return (
                                                            <tr key={key}>
                                                                ...
                                                                <td className="product-name">
                                                                    <Link to={"/product/" + cartItem.description.friendlyUrl}>{cartItem.description.name}</Link>
                                                                </td>
                                    ...
                                    <Fragment>
                                      ...
                                      <span className="amount">
                                        {finalDiscountedPrice}
                                                                    ...
                                                                    <span className="amount">{finalDiscountedPrice}</span>
                                                                    {/* )} */}
                                                                </td>
                                    ...
                                    <div className="col-lg-12">
                                        <div className="cart-shiping-update-wrapper">
                                            <div className="cart-clear">
                                                <button onClick={() => deleteAllFromCart()}>{strings["Clear Shopping Cart"]}</button>
                                            </div>
                                    ...
                                    <div className="col-lg-8 col-md-6 cart-total">
                                        <div className="box-custom">
                                            <div className="discount-code-wrapper coupon-code">
                                                <div className="title-wrap">
                                                    <h4 className="cart-bottom-title section-bg-gray">{strings["Use Coupon Code"]}</h4>
                                                </div>
                                                {cartItems.promoCode ? (
                                                    ...
                                                    <div className="discount-code">
                                                        ...
                                                        <form onSubmit={codeSubmit(applyPromoCode)}>
                                                            ...
                                                            {codeErr[couponCode.code.name] && (
                                                                <p className="error-msg">{codeErr[couponCode.code.name].message}</p>
                                                            )}
                                                            <button className="cart-btn-2" type="submit">
                                            ...
                                            <div className="grand-totall cart-total-box">
                                                <div className="title-wrap">
                                                    <h4 className="cart-bottom-title section-bg-gary-cart">{strings["Cart Total"]}</h4>
                                                </div>
                                                <h5>
                                                    {strings["Total products"]} <span>{cartItems.displaySubTotal}</span>
                                                </h5>
                                                <h4 className="grand-totall-title">
                                                    {strings["Grand Total"]} <span>{cartItems.displaySubTotal}</span>
                                                </h4>
                                                <Link to={process.env.PUBLIC_URL + "/checkout"}>{strings["Proceed to Checkout"]}</Link>
                                            </div>
                                        </div>
                                        {shippingOptions && (
                                            <div className="grand-totall" style={{ marginTop: 30 }}>
                                                <div className="title-wrap">
                                                    <h4 className="cart-bottom-title section-bg-gary-cart">{"Shipping and tax"}</h4>
                                                </div>
                                                {shippingOptions.map((value, i) => {
                                                    return (
                                                        <h5 key={i}>
                                                            {value.optionName} <span>{value.optionPriceText}</span>
                                                        </h5>
                                                    );
                                                })}
                                            </div>
                                    ...
                                    <div className="col-lg-12">
                                        <div className="item-empty-area text-center">
                                            ...
                                            <div className="item-empty-area__text">
                                                {strings["No items found in cart"]} <br /> <Link to="/">{strings["Shop now"]}</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
