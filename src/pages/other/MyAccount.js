...
const MyAccount = ({
    ...
    const { register: billingRef, errors: billingErr, handleSubmit: billingSubmit, control, setValue } = useForm({
        mode: "onChange",
    });
    const { register: deliveryRef, errors: deliveryErr, handleSubmit: deliverySubmit, control: deliveryControl, setValue: setDeliveryValue } = useForm({
        mode: "onChange",
    });
    const { register: accountRef, errors: accountErr, handleSubmit: accountSubmit, setValue: setAccountValue } = useForm({
        mode: "onChange",
    });
        ...
        try {
            ...
            if (response) {
                ...
                if (response.delivery) {
                    ...
                    setDeliveryValue("shipCountry", response.delivery.countryCode);
                    setDeliveryValue("shipCity", response.delivery.city);
                    setDeliveryValue("shipStateProvince", response.delivery.stateProvince);
    ...
    const onConfirmPassword = (e) => {
        if (watch("password") !== e.target.value) {
            return setError(changePasswordForm.repeatPassword.name, {
                type: "notMatch",
    ...
    const handleDeliveryScriptLoad = () => {
        ...
        let autocomplete = new google.maps.places.Autocomplete(document.getElementById("autocomplete1"), options);
        // console.log(autocomplete)
        // Avoid paying for data that you don't need by restricting the set of
        // place fields that are returned to just the address components and formatted
        // address.
    ...
    return (
        <Fragment>
            <MetaTags>
                <title>
                    {merchant.name} | {strings["My Account"]}
                </title>
                {/* <meta
          name="description"
        ...
        /> */}
            ...
            <BreadcrumbsItem to={process.env.PUBLIC_URL + pathname}>{strings["My Account"]}</BreadcrumbsItem>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-12 col-md-12">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={accountForm.username.name}
                                                                            ref={accountRef(accountForm.username.validate)}
                                                                        />
                                                                        {accountErr[accountForm.username.name] && (
                                                                            <p className="error-msg">{errors[accountForm.username.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-12 col-md-12">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={accountForm.email.name}
                                                                            ref={accountRef(accountForm.email.validate)}
                                                                        />
                                                                        {accountErr[accountForm.email.name] && (
                                                                            <p className="error-msg">{accountErr[accountForm.email.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.firstName.name}
                                                                            ref={billingRef(billingForm.firstName.validate)}
                                                                        />
                                                                        {billingErr[billingForm.firstName.name] && (
                                                                            <p className="error-msg">{billingErr[billingForm.firstName.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.lastName.name}
                                                                            ref={billingRef(billingForm.lastName.validate)}
                                                                        />
                                                                        {billingErr[billingForm.lastName.name] && (
                                                                            <p className="error-msg">{billingErr[billingForm.lastName.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-12">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.company.name}
                                                                            ref={billingRef(billingForm.company.validate)}
                                                                        />
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-12">
                                                                    <div className="billing-info mb-20">
                                                                        <Script
                                                                            url={
                                                                                ...
                                                                                process.env.REACT_APP_APP_MAP_API_KEY +
                                                                                "&libraries=places"
                                                                            }
                                                                        ...
                                                                        />
                                                                        {billingErr[billingForm.address.name] && (
                                                                            <p className="error-msg">{billingErr[billingForm.address.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        />
                                                                        {billingErr[billingForm.country.name] && (
                                                                            <p className="error-msg">{billingErr[billingForm.country.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        {stateData && stateData.length > 0 ? (
                                                                            ...
                                                                            <input
                                                                                type="text"
                                                                                name={billingForm.stateProvince.name}
                                                                                ref={billingRef(billingForm.stateProvince.validate)}
                                                                                placeholder={strings["State"]}
                                                                            />
                                                                        )}
                                                                        {billingErr[billingForm.stateProvince.name] && (
                                                                            <p className="error-msg">{billingErr[billingForm.stateProvince.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.city.name}
                                                                            ref={billingRef(billingForm.city.validate)}
                                                                        />
                                                                        {billingErr[billingForm.city.name] && (
                                                                            <p className="error-msg">{billingErr[billingForm.city.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.postalCode.name}
                                                                            ref={billingRef(billingForm.postalCode.validate)}
                                                                        />
                                                                        {billingErr[billingForm.postalCode.name] && (
                                                                            <p className="error-msg">{billingErr[billingForm.postalCode.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                {/* <div className="col-lg-6 col-md-6">
                                    ...
                                    {billingErr[billingForm.email.name] && <p className="error-msg">{billingErr[billingForm.email.name].message}</p>}
                                                                ...
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="number"
                                                                            name={billingForm.phone.name}
                                                                            ref={billingRef(billingForm.phone.validate)}
                                                                        />
                                                                        {billingErr[billingForm.phone.name] && (
                                                                            <p className="error-msg">{billingErr[billingForm.phone.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.shipFirstName.name}
                                                                            ref={deliveryRef(billingForm.shipFirstName.validate)}
                                                                        />
                                                                        {deliveryErr[billingForm.shipFirstName.name] && (
                                                                            <p className="error-msg">{deliveryErr[billingForm.shipFirstName.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.shipLastName.name}
                                                                            ref={deliveryRef(billingForm.shipLastName.validate)}
                                                                        />
                                                                        {deliveryErr[billingForm.shipLastName.name] && (
                                                                            <p className="error-msg">{deliveryErr[billingForm.shipLastName.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-12">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.shipCompany.name}
                                                                            ref={deliveryRef(billingForm.shipCompany.validate)}
                                                                        />
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-12">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        />
                                                                        {deliveryErr[billingForm.shipAddress.name] && (
                                                                            <p className="error-msg">{deliveryErr[billingForm.shipAddress.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        />
                                                                        {deliveryErr[billingForm.shipCountry.name] && (
                                                                            <p className="error-msg">{deliveryErr[billingForm.shipCountry.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        {stateData && stateData.length > 0 ? (
                                                                            ...
                                                                            <input
                                                                                type="text"
                                                                                name={billingForm.shipStateProvince.name}
                                                                                ref={deliveryRef(billingForm.shipStateProvince.validate)}
                                                                                placeholder={strings["State"]}
                                                                            />
                                                                        )}
                                                                        {deliveryErr[billingForm.shipStateProvince.name] && (
                                                                            <p className="error-msg">
                                                                                {deliveryErr[billingForm.shipStateProvince.name].message}
                                                                            </p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.shipCity.name}
                                                                            ref={deliveryRef(billingForm.shipCity.validate)}
                                                                        />
                                                                        {deliveryErr[billingForm.shipCity.name] && (
                                                                            <p className="error-msg">{deliveryErr[billingForm.shipCity.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info mb-20">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            name={billingForm.shipPostalCode.name}
                                                                            ref={deliveryRef(billingForm.shipPostalCode.validate)}
                                                                        />
                                                                        {deliveryErr[billingForm.shipPostalCode.name] && (
                                                                            <p className="error-msg">{deliveryErr[billingForm.shipPostalCode.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                {/* <div className="col-lg-6 col-md-6">
                                    ...
                                    {billingErr[billingForm.shipEmail.name] && <p className="error-msg">{billingErr[billingForm.shipEmail.name].message}</p>}
                                                                ...
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="number"
                                                                            name={billingForm.shipPhone.name}
                                                                            ref={deliveryRef(billingForm.shipPhone.validate)}
                                                                        />
                                                                        {deliveryErr[billingForm.shipPhone.name] && (
                                                                            <p className="error-msg">{deliveryErr[billingForm.shipPhone.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-12 col-md-12">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            type="password"
                                                                            name={changePasswordForm.currentPassword.name}
                                                                            ref={register(changePasswordForm.currentPassword.validate)}
                                                                        />
                                                                        {errors[changePasswordForm.currentPassword.name] && (
                                                                            <p className="error-msg">
                                                                                {errors[changePasswordForm.currentPassword.name].message}
                                                                            </p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-12 col-md-12">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            ref={register(changePasswordForm.password.validate)}
                                                                        />
                                                                        {errors[changePasswordForm.password.name] && (
                                                                            <p className="error-msg">{errors[changePasswordForm.password.name].message}</p>
                                                                        )}
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-12 col-md-12">
                                                                    <div className="billing-info">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            name={changePasswordForm.repeatPassword.name}
                                                                            ref={register(changePasswordForm.repeatPassword.validate)}
                                                                        />
                                                                        {errors[changePasswordForm.repeatPassword.name] && (
                                                                            <p className="error-msg">
                                                                                {errors[changePasswordForm.repeatPassword.name].message}
                                                                            </p>
                                                                        )}
                                                                    </div>
                                                                </div>
