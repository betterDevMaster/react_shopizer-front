                                    ...
                                    <div className="pro-details-size-content">
                                        {
                                            ...
                                            >
                                                ...
                                                {option.optionValues.map((singleSize, i) => {
                                                    return (
                                                        <option key={i} value={JSON.stringify(singleSize)} selected={checkedOrNot(singleSize)}>
                ...
                <div className="pro-details-meta">
                    ...
                    <ul>
                        {product.categories.map((single, key) => {
                            return (
                                <li key={key}>
                                    <Link to={"/category/" + single.description.friendlyUrl}>{single.description.name}</Link>
                                </li>
                            );
                        })}
                    </ul>
